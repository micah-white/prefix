#include "edu_cs606_MessageJNI.h"
#include <stdio.h>
#include <sys/ipc.h>
#include <sys/msg.h>
#include <errno.h>
 ...
 * Signature: (Ljava/lang/String;I)Ledu/cs606/SearchRequest;
 */
...
(JNIEnv *env, jobject obj) {
    ...
    jclass searchRequestClass = (*env)->FindClass(env,"edu/cs606/SearchRequest");
